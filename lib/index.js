...
exports.register = function(codes) {
	Object.keys(codes).forEach(function(code) {
		...
		exports[className.substr(0, 1).toLowerCase() + className.substr(1)] = function(message, tags) {
...
var err = exports.unauthorized("abba");
console.log(new exports.Unauthorized("abba"));
